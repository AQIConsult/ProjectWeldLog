...
<style>
    ...
    .stApp {
        background: 
            radial-gradient(ellipse 90% 60% at 10% -20%, rgba(37, 99, 235, 0.06), transparent),
            radial-gradient(ellipse 70% 50% at 95% 5%, rgba(14, 165, 233, 0.04), transparent),
            var(--bg) !important;
    ...
    /* Custom cards — soft elevated surfaces */
    ...
    /* Sidebar — clean white with subtle depth */
    ...
    .stDataFrame, .metric-container, .section-card {
...
if dark_mode:
    ...
    <style>
        ...
        .stApp {
            background: 
                radial-gradient(ellipse 80% 50% at 20% -10%, rgba(56, 189, 248, 0.07), transparent),
                radial-gradient(ellipse 60% 40% at 90% 10%, rgba(99, 102, 241, 0.05), transparent),
                var(--bg) !important;
            color: var(--text) !important;
        }
        ...
        .metric-container, .section-card {
            background: linear-gradient(145deg, rgba(22, 30, 46, 0.85), rgba(15, 22, 35, 0.9)) !important;
        ...
        /* Streamlit data editor / dataframe container */
